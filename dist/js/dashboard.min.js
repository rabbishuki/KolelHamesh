...
function MasterCtrl(t,o){var e=992;t.getWidth=function(){return window.innerWidth},t.logout=function(){document.cookie="token=; Max-Age=0;",window.location.href="/"},t.$watch(t.getWidth,function(g,n){g>=e?angular.isDefined(o.get("toggle"))?t.toggle=!!o.get("toggle"):t.toggle=!0:t.toggle=!1}),t.toggleSidebar=function(){t.toggle=!t.toggle,o.put("toggle",t.toggle)},window.onresize=function(){t.$apply()}}angular.module("RDash").controller("MasterCtrl",["$scope","$cookieStore",MasterCtrl]);
function rdLoading(){var d={restrict:"AE",template:'<div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>'};return d}angular.module("RDash").directive("rdLoading",rdLoading);
